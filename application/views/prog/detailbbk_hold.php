<?php
	foreach($bbkhold as $bbkh){
		$oida 		= $bbkh->objectid;
		$dibayarke 	= $bbkh->dibayar_ke;
		$nofaktur	= $bbkh->no_faktur;
		$supplier	= $bbkh->supplier;
		$bpb		= $bbkh->bpb;
		$btb		= $bbkh->btb;
		$nobbk		= $bbkh->no_dokumen;
		$daybook	= $bbkh->daybook;
	}
...
<body>	
	...
	<form action="<?php echo base_url(); ?>bbk_hold/daybookbbk" method="post" class="form-horizontal"  enctype="multipart/form-data" >
	<table>
		<tr>
			...
			<td><b>No. BBK :</b></td>
			<td><input type="text" name="oida" id="oida" value="<?php echo $oida; ?>"><input type="text" name="nobbk" id="nobbk" value="<?php echo $nobbk; ?>"></input></td>
			<td>&nbsp;&nbsp;</td>
	...
	<table class="table table-striped mb-0">
		<tr>
			...
			<form action="<?php echo base_url(); ?>bbk_hold/updatebbk" method="post" class="form-horizontal"  enctype="multipart/form-data" >
			<?php
				$nom = 0;
				$jumtot =0;
				foreach($detbbkhold as $detbbkh){
					$nom = $nom + 1;
					$parentid = $detbbkh->parentobjectid;
					$jumtot = $jumtot + $detbbkh->jumlah;
					echo"<tr>";
					echo"<td>".$nom."</td>";
					echo"<td>".$detbbkh->keterangan."</td>";
					echo"<td><input type='text' style='width:150px' name='gl$nom' id='gl$nom' value='".$detbbkh->no_perkiraan."'></input></td>";
					echo"<td><input type='text' style='width:150px' name='cost$nom' id='cost$nom' value='".$detbbkh->cost_center."'></input></td>";
					echo"<td><input type='text' style='width:150px' name='proj$nom' id='proj$nom' value='".$detbbkh->project."'></input>
							<input type='hidden' style='width:150px' name='objid$nom' id='objid$nom' value='".$detbbkh->objectid."'></input></td>";
					echo"<td>".number_format($detbbkh->jumlah)."</td>";	
					echo"</tr>";
				}
				echo"<tr><td/><td/><td/><td/><td/><td><b>".number_format($jumtot)."</b></td></tr>";
				echo"<tr>
						<td colspan='6'>
							<input type='hidden' name='parent' id='parent' value='".$detbbkh->parentobjectid."'></input>
