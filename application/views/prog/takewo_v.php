	...
	<div class="main-content-inner">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">Waiting List WO</li>
			</ul><!-- /.breadcrumb -->
		</div>
			...
			<div class="panel-body">
                <table data-toggle="table"  data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
					...
					<tbody>
						<?php 
							$i=1;
							foreach($wotake as $tkw){
								echo"<tr>
									<td>".$i."</td>
									<td>".$tkw->no_wo."</td>
									<td>".$tkw->uraian_pekerjaan."</td>
									<td>".$tkw->status_wo."</td>
									<td>
										<input type='hidden' name='txttake' id='txttake' value='".$tkw->no_wo."'>
										<input type='hidden' name='txtadmin' id='txtadmin' value='".$uname."'>
										<button type='button' class='edit-record btn btn-primary btn-xs' data-id='".$tkw->no_wo."'>TAKE</button>
										<input type='button' class='btn btn-danger btn-xs' onclick=window.open('reject_pp.php?kode='".$tkw->no_wo."','winpopup', 'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=500,height=580') value='REJECT'>
									</td>
									</tr>";
								$i++;
							}
