								...
								<tbody>
										...
										<?php
											foreach($bbkhold as $bbkh){
												echo"<tr>";
												echo"<td>".$bbkh->tgl_bk."</td>";
												echo"<td>".$bbkh->dibayar_ke."</td>";
												echo"<td>".$bbkh->bpb."</td>";
												echo"<td>".$bbkh->btb."</td>";
												echo"<td>".$bbkh->no_faktur."</td>";
												echo"<td>".number_format($bbkh->jumlah,0,",",".")."</td>";
												echo"<td>
														<a href='".base_url()."bbk_hold/vi_entrycerai/".$bbkh->objectid."' target='datcer' type='button' rel='tooltip' class='btn btn-primary btn-sm btn-edit' data-toggle='modal'  >Lihat Detail</a>";
												?>	
														<a href="#" type="button" class="btn btn-info btn-sm btn-delete" data-toggle="modal" onclick="deleteConfirm('<?php echo base_url('bbk_hold/batalbbk/'.$bbkh->objectid); ?>')" >Batalkan</a>
												<?php
												echo"</td>";
												echo"</tr>";
											}
	...
	<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">Yakin Voucher BBK akan di batalkan?.</div>
